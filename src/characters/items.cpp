...
const Weapon weaponDatabase[] =
{
	...
	// Club
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 6, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_BLUDGEONS },
	// Dagger
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 4, 19, 2,  10, WEAPON_PROP_FINESSE | WEAPON_PROP_THROWN, WEAPON_GROUP_BLADES },
	// Greatclub
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1,10, 20, 2,   0, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_BLUDGEONS },
	// Light Hammer
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 4, 20, 2,  20, WEAPON_PROP_THROWN, WEAPON_GROUP_BLUDGEONS },
	// Mace
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 8, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_BLUDGEONS },
	// Morningstar
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 8, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_BLUDGEONS },
	// Quarterstaff
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 6, 20, 2,   0, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_BLUDGEONS },
	// Shortspear
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 6, 20, 2,  20, WEAPON_PROP_THROWN, WEAPON_GROUP_POLEARMS },
	// Sickle
	{ WEAPON_MELEE, DAMAGE_SLASHING,    1, 6, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_BLADES },
	// Spear
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 8, 20, 3,  20, WEAPON_PROP_THROWN | WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_POLEARMS },
	...
	// Battleaxe
	{ WEAPON_MELEE, DAMAGE_SLASHING,    1, 8, 20, 3,   0, WEAPON_PROP_NONE, WEAPON_GROUP_AXES },
	// Falchion
	{ WEAPON_MELEE, DAMAGE_SLASHING,    2, 4, 18, 2,   0, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_BLADES },
	// Flail
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 8, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_BLUDGEONS },
	// Greataxe
	{ WEAPON_MELEE, DAMAGE_SLASHING,    1,12, 20, 3,   0, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_AXES },
	// Greatsword
	{ WEAPON_MELEE, DAMAGE_SLASHING,    2, 6, 19, 2,   0, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_BLADES },
	// Heavy Pick
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 6, 20, 4,   0, WEAPON_PROP_NONE, WEAPON_GROUP_AXES },
	// Lance
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 8, 20, 3,   0, WEAPON_PROP_REACH, WEAPON_GROUP_POLEARMS },
	// Longsword
	{ WEAPON_MELEE, DAMAGE_SLASHING,    1, 8, 19, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_BLADES },
	// Rapier
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 6, 18, 2,   0, WEAPON_PROP_FINESSE, WEAPON_GROUP_BLADES },
	// Scimitar
	{ WEAPON_MELEE, DAMAGE_SLASHING,    1, 6, 18, 2,   0, WEAPON_PROP_FINESSE, WEAPON_GROUP_BLADES },
	// Trident
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 8, 20, 2,  10, WEAPON_PROP_THROWN, WEAPON_GROUP_POLEARMS },
	// Warhammer
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 8, 20, 3,   0, WEAPON_PROP_NONE, WEAPON_GROUP_BLUDGEONS },
	...
	// Shortbow
	{ WEAPON_RANGED, DAMAGE_PIERCING,   1, 6, 20, 3,  60, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_BOWS },
	// Longbow
	{ WEAPON_RANGED, DAMAGE_PIERCING,   1, 8, 20, 3, 100, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_BOWS },
	// Composite Longbow
	{ WEAPON_RANGED, DAMAGE_PIERCING,   1, 8, 20, 3, 110, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_BOWS },
	// Light Crossbow
	{ WEAPON_RANGED, DAMAGE_PIERCING,   1, 8, 19, 2,  80, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_CROSSBOWS },
	// Heavy Crossbow
	{ WEAPON_RANGED, DAMAGE_PIERCING,   1,10, 19, 2, 120, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_CROSSBOWS },
	// Sling
	{ WEAPON_RANGED, DAMAGE_BLUDGEONING,1, 4, 20, 2,  50, WEAPON_PROP_NONE, WEAPON_GROUP_SLINGS },
	...
	// Bite
	{ WEAPON_MELEE, DAMAGE_PIERCING,    1, 6, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_NATURAL },
	// Claws
	{ WEAPON_MELEE, DAMAGE_SLASHING,    1, 4, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_NATURAL },
	// Slam
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 6, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_NATURAL },
	// Tentacle
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 4, 20, 2,   0, WEAPON_PROP_REACH, WEAPON_GROUP_NATURAL },
	// Pseudopod
	{ WEAPON_MELEE, DAMAGE_BLUDGEONING, 1, 6, 20, 2,   0, WEAPON_PROP_NONE, WEAPON_GROUP_NATURAL },
	// Scythe
	{ WEAPON_MELEE, DAMAGE_SLASHING,    2, 4, 20, 4,   0, WEAPON_PROP_TWO_HANDED, WEAPON_GROUP_BLADES }
};
...
const char* getWeaponGroupName(WeaponGroup group)
{
	switch (group)
	{
		case WEAPON_GROUP_BLADES: return "Blades";
		case WEAPON_GROUP_AXES: return "Axes";
		case WEAPON_GROUP_BLUDGEONS: return "Bludgeons";
		case WEAPON_GROUP_POLEARMS: return "Polearms";
		case WEAPON_GROUP_BOWS: return "Bows";
		case WEAPON_GROUP_CROSSBOWS: return "Crossbows";
		case WEAPON_GROUP_SLINGS: return "Slings";
		case WEAPON_GROUP_NATURAL: return "Natural";
		case WEAPON_GROUP_NONE:
		default: return "None";
	}
}
